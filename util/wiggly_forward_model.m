...
function y_hat = wiggly_forward_model(timestamps, baseline, signal_ID_per_chan, signal_code_table, ...
    event_signal_IDs, event_t_centers, event_t_transits, event_amps, ...
    event_node_amp_factors, event_node_dur_factors, event_accel_factors, rise_time, stdev)
    ...
    for event_ix = 1:num_events
        ...
        event_model = wiggly_single_event_model(signal_code_table(event_signal_IDs(event_ix),:), ...
            timestamps, ...
