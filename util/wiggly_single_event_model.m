...
function event_model = wiggly_single_event_model(signal_code, timestamps, t_center, t_transit, amp, node_amp_factor, node_dur_factor, accel_factor, rise_time, stdev)
    ...
    % wiggle the edge_times
    edge_times = edge_times + randn(size(edge_times))*stdev;
    edge_times = edge_times ./ edge_times(end); % renormalize to [0, 1]
